...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4 mt-4 mb-xl-4">180 Assessments</h4>
<p id="success"></p>
		...
		<div class="modal-content">
			<form id="user_form">
				<div class="modal-header">						
					<h4 class="modal-title">Add 180 Assessment</h4>
				...
				<div class="modal-body">				
					...
					<div class="form-group">
						...
						<input type="text" id="completion" name="complation" class="form-control" autocomplete="off" required>
					</div>

										
					<div class="form-group">
						<label>Date</label>
						<input type="date" id="date" name="date" class="form-control datepicker"  autocomplete="off" required>
					</div>
...
<div id="editEmployeeModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form id="update_form">
				<div class="modal-header">						
					<h4 class="modal-title">Edit 180 Assessment</h4>
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
				</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label>Student Name</label>
						<input type="text" id="stuname_u" name="studentname" class="form-control" required>
					</div>

					<div class="form-group">
						<label>Completion</label>
						<input type="text" id="completion_u" name="completion" class="form-control" required>
					</div>

					<div class="form-group">
						<label>Date</label>
						<input type="Date" id="Date_u" name="Date" class="form-control datepicker" required>>
					</div>
