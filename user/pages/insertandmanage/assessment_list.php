...
<div>
	<div class="col-12 grid-margin">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title mb-4 mt-4 mb-xl-4">Assessments</h4>
				<p id="success"></p>
									...
									<tr class="border-bottom" id="<?php echo $row["AssessmentID"]; ?>">
										<td>
											<a href="#editEmployeeModal" class="edit" data-toggle="modal">
												<i class="material-icons update" data-AssessmentID_u="<?php echo $row["AssessmentID"]; ?>" data-AssessmentName_u="<?php echo $row["AssessmentName"]; ?>" data-AssessmentType_u="<?php echo $row["AssessmentType"]; ?>" title="Edit"></i>
											</a>
