...
?>
                            ...
                            CASE
                                ...
                                WHEN postSalesFollowUp = 'Completed' AND programCompleted = 'In Progress' THEN 'Program in Progress'
                                WHEN postSalesFollowUp = 'Completed' THEN 'Post Sales'
                                WHEN programCompleted = 'Completed' THEN 'Program Completed'
                                WHEN cof = 'Completed' THEN 'Deployment'
...
function loadSavedNames() {
    ...
    <select class="strategicPriorityDropdown" data-id="<?php echo $row["clientID"]; ?>">
        <option value="1" <?php if ($row["strategicPriority"] == 1) echo 'selected'; ?>>1</option>
        <option value="2" <?php if ($row["strategicPriority"] == 2) echo 'selected'; ?>>2</option>
        <option value="3" <?php if ($row["strategicPriority"] == 3) echo 'selected'; ?>>3</option>
        <option value="4" <?php if ($row["strategicPriority"] == 4) echo 'selected'; ?>>4</option>
        <option value="5" <?php if ($row["strategicPriority"] == 5) echo 'selected'; ?>>5</option>
    </select>
</td>
<script>
document.addEventListener('DOMContentLoaded', function() {
...
<td>
    <select class="confidenceLevelDropdown" data-id="<?php echo $row["clientID"]; ?>">
        <option value="1" <?php if ($row["confindeceLevelRating"] == 1) echo 'selected'; ?>>1</option>
        <option value="2" <?php if ($row["confindeceLevelRating"] == 2) echo 'selected'; ?>>2</option>
        <option value="3" <?php if ($row["confindeceLevelRating"] == 3) echo 'selected'; ?>>3</option>
        <option value="4" <?php if ($row["confindeceLevelRating"] == 4) echo 'selected'; ?>>4</option>
        <option value="5" <?php if ($row["confindeceLevelRating"] == 5) echo 'selected'; ?>>5</option>
    </select>
</td>
<script>
document.addEventListener('DOMContentLoaded', function() {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    <select id="ltype_u" name="ltype" class="form-control" autocomplete="off" required>
        <option value="Consulting" <?php if ($selectedLType == 'Consulting') echo 'selected'; ?>>Consulting</option>
        <option value="Training" <?php if ($selectedLType == 'Training') echo 'selected'; ?>>Training</option>
        <option value="People Analytics" <?php if ($selectedLType == 'People Analytics') echo 'selected'; ?>>People Analytics</option>
    </select>
</div>
...
<div class="form-group">
    ...
    <select id="Categorytype_u" name="Categorytype" class="form-control" autocomplete="off" required>
        <option value="PLDP" <?php if ($selectedCategoryType == 'PLDP') echo 'selected'; ?>>PLDP</option>
        <option value="Capacity Building" <?php if ($selectedCategoryType == 'Capacity Building') echo 'selected'; ?>>Capacity Building</option>
        <option value="EDP" <?php if ($selectedCategoryType == 'EDP') echo 'selected'; ?>>EDP</option>
        <option value="CSP" <?php if ($selectedCategoryType == 'CSP') echo 'selected'; ?>>CSP</option>
        <option value="OAR" <?php if ($selectedCategoryType == 'OAR') echo 'selected'; ?>>OAR</option>
        <option value="Team Experiences" <?php if ($selectedCategoryType == 'Team Experiences') echo 'selected'; ?>>Team Experiences</option>
        <option value="Strategy" <?php if ($selectedCategoryType == 'Strategy') echo 'selected'; ?>>Strategy</option>
        <option value="HR" <?php if ($selectedCategoryType == 'HR') echo 'selected'; ?>>HR</option>
        <option value="Other" <?php if ($selectedCategoryType == 'Other') echo 'selected'; ?>>Other</option>
    </select>
</div>-->
