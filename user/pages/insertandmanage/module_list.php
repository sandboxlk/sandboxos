							...
							<tbody>
								...
								?>
									<tr class="border-bottom" id="<?php echo $row["ModuleID"]; ?>">
										...
										<td><input type="button" id="hiddenModuleID" name="hiddenModuleID" value="<?php echo $row["ModuleID"]; ?>"></td>

										<td>
											<!-- "Add Session Plans" button moved here -->
											<a href="#" class="btn btn-sm btn-primary add-session" data-toggle="modal" data-target="#addSessionPlansModal" data-ModuleID="<?php echo $row["ModuleID"]; ?>" onclick="showModuleID(<?php echo $row['ModuleID']; ?>)">
												Add Session Plans
											</a>
