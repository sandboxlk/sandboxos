									...
									<tr class="border-bottom" id="<?php echo $row["RegistrationID"]; ?>">
										<td>
											<a href="#editEmployeeModal" class="edit" data-toggle="modal">
												<i class="material-icons update" data-toggle="tooltip" data-id="<?php echo $row["RegistrationID"]; ?>" data-company="<?php echo $row["client"]; ?>" data-course="<?php echo $row["course"]; ?>" data-year="<?php echo $row["year"]; ?>" data-batch="<?php echo $row["batchName"]; ?>" data-budget="<?php echo $row["budgetParticipant"]; ?>" data-StartDate="<?php echo $row["StartDate"]; ?>" data-EndDate="<?php echo $row["EndDate"]; ?>" title="Edit"></i>
											</a>
									...
									<div class="modal-body">
											...
											<select class="form-control" id="company" name="company">
												...
												if (mysqli_num_rows($result) > 0) {
													while ($row = mysqli_fetch_assoc($result)) {
														echo "<option value=" . $row["clientName"] . ">" . $row["clientName"] . "</option><br>";
													}
												} else {
										...
										<div class="form-group">
											...
											<select class="form-control" id="course" name="course">
												<?php
												$sql_ = "SELECT CourseName, CourseName FROM courses";
												$result_ = mysqli_query($conn, $sql_);

												if (mysqli_num_rows($result_) > 0) {
													while ($rowc = mysqli_fetch_assoc($result_)) {
														echo "<option value=" . $rowc["CourseName"] . ">" . $rowc["CourseName"] . "</option><br>";
													}
												} else {
