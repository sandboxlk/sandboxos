...
?>
	...
	<script src="pages/insertandmanage/student_reg_list_ajax.js"></script>
<div>
...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4 mt-4 mb-xl-4">Student Registration</h4>
<p id="success"></p>
    ...
    <div class="table-responsive">
		<table class="table table-hover">
			...
			<?php
			$result = mysqli_query($conn,"SELECT * FROM student_registration ORDER BY StudentName ASC");
				$i=1;
				...
				$clientid = $row["reg_id"];	
			?>
			<tr class="border-bottom" id="<?php echo $row["reg_id"]; ?>">
			<td>
					<a href="#editEmployeeModal" class="edit" data-toggle="modal">
						...
						data-clientID="<?php echo $row["clientID"]; ?>"
