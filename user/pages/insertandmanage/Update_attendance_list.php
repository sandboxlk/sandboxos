...
?> 
	...
	<script src="pages/insertandmanage/Update_attendance_list_ajax.js"></script>
<div>
...
<div class="card">
<div class="card-body">
<h4 class="card-title mb-4 mt-4 mb-xl-4">Update Attendance</h4>
<p id="success"></p>
    ...
    <div class="table-responsive">
		<table class="table table-hover">
			...
			<?php
			$result = mysqli_query($conn,"SELECT * FROM update_attendance ORDER BY CompanyName ASC");
				$i=1;
			...
			<td>
					<a href="#editEmployeeModal" class="edit" data-toggle="modal">
						...
						data-CompanyName="<?php echo $row["CompanyName"]; ?>"
						data-batch="<?php echo $row["batch"]; ?>"
						data-module="<?php echo $row["module"]; ?>"
						data-PersonalityTest="<?php echo $row["PersonalityTest"]; ?>"
						data-180="<?php echo $row["180"]; ?>"
						data-360="<?php echo $row["360"]; ?>"
						data-KnowledgeAssessment="<?php echo $row["KnowledgeAssessment"]; ?>"
						data-CulturePulse="<?php echo $row["CulturePulse"]; ?>"
						data-CompitencyGap="<?php echo $row["CompitencyGap"]; ?>"
						title="Edit"></i>
					</a>
					<a href="#deleteEmployeeModal" class="delete" data-id="<?php echo $row["CompanyName"]; ?>" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" 
						title="Delete"></i></a>
				</td>
		...
		<div class="modal-content">
			<form id="user_form">
				<div class="modal-header">						
					<h4 class="modal-title">Update new attendance </h4>
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						<label>Culture Pulse</label>
						<input type="text" id="email" name="email" class="form-control" autocomplete="off" required>
					</div>
					<div class="form-group">
						<label>Compitency gap</label>
						<input type="text" id="email" name="email" class="form-control" autocomplete="off" required>
					</div>
